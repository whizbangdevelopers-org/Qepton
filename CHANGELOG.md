...
### Changed
- Upgraded Vite from 5.4 to 7.3
- Migrated to ESLint 9 flat config format

### Added
- Help tip for escaping zoom mode (press Escape)

### Fixed
- Various CI/CD workflow improvements (cleanup action, permissions, PR creation)

## [1.0.21] - 2026-02-04

### Fixed
- E2E tests now enforced when pushing version tags
